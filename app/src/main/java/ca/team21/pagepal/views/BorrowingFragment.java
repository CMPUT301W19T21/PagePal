...
public class BorrowingFragment extends Fragment {
    ...
    private OnBorrowingInteractionListener mListener;
    ...
    public void onButtonPressed() {
        if (mListener != null) {
            mListener.onBorrowingInteraction();
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnBorrowingInteractionListener) {
            mListener = (OnBorrowingInteractionListener) context;
        } else {
